...
**R automaticall convert element in a vector to the same type when mixed types are specified. In this case it converts numeric to character type since '3' and '4' are specified character type.**
