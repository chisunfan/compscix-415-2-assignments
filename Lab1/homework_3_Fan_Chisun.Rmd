...
###vars <- ("dep_time","dep_delay","arr_time","arr_delay") 
###select(flights,vars)
...
###one_of matches name against any string in the vector. It is helpful because it is more intepretive using the function. In reality thers is no difference with or without it.
